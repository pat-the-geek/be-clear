...
| ✅ Fait | **Tests automatisés** | Suite pytest-asyncio (SQLite in-memory) : 61 tests — auth, CRUD ORG/ENV/ENG/EVENT, duplication ENG, règles métier RF-02/RF-03/RF-04/RF-11/RF-12/RF-13/RF-15, OIDC state HMAC, crypto |
