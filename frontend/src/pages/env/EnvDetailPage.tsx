          ...
          <div className="grid grid-cols-3 gap-3">
            {env.obj.images.map((img) => (
              <div key={img.id} className="relative">
                ...
                />
                {img.est_principale && (
                  <span className="absolute top-1.5 left-1.5 text-xs bg-orange-500 text-white px-1.5 py-0.5 rounded font-medium">
                    Principale
                  </span>
                )}
              </div>
